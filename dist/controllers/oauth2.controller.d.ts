...
export declare class Oauth2Controller {
     ...
     */
    loginToThirdParty(provider: string, redirectUrl: string, status: number, response: Response): Response<any, Record<string, any>>;
    thirdPartyCallBack(provider: string, user: UserProfile, request: RequestWithSession, response: Response): Promise<Response<any, Record<string, any>>>;
}
